...
if (count($_POST) > 0) {
    foreach ($Groups as $_groupRow) {
        ...
        foreach ($QuestionListByGroup as $_questionRow) {
            ...
            // a számlázási címet, email címet és a telefonszámot nem mentjük le adatbázisba adatbiztonság miatt
...
if ($saved) {
    ...
    $body = "<html>
			<body>
				<div>Számlázási cím (ha még nem adtad meg): {$_POST[311]}</div>
				<div>Email cím: {$_POST[137]}</div>
				<div>Telefonszám: {$_POST[138]}</div>
			</body>
		</html>";

    simpleMail($consUserObj["email"], iconv("latin2", "utf-8", $_POST[133]) . iconv("latin2", "utf-8", " kitöltötte a kérdõívet"), $body);
    ...
    <form id="mainForm" method="post" action="" method="POST">
        ...
        <div>
            <table width='800px' border="0" align="center" style="font-family:arial">
                <tr>
                    <td>
                        ...
                        <table border='0' width='100%'>
                            <tr>
                                <td style='padding-top:50px;font-size:40pt;text-align:center;color:#1B5A09'><b>Esetfelmérõ kérdõívv</b></td>
                            </tr>
                            <tr>
                                        ...
                                        ?>
                                            <tr align="left">
                                                <td height="40">
                                                    ...
                                                    <?php if ($_questionRow["other_use"]) { ?>
                                                        <p>
															<span style="display:inline-block;height:80px;vertical-align:middle;margin-right:10px">Egyéb:</span>
                ...
                <tr>
                    <td style="padding-top: 20px;"><input type="checkbox" id="cbAdatv" value="1"><label for="cbAdatv">Megértettem és elfogadtam az <a href="https://yourhealth.store/at/" target="_blank">Adatvédelmi Tájékoztatót.</a></label></td>
                </tr>
                <tr>
