...
<td>
    ...
    <table>
    <tr>
    <td style='padding-top:50px;padding-bottom:50px;font-size:40pt;text-align:center;color:#fd8604'><b>Táplálkozási Profil&trade;</td></tr>
    <tr>
    <td style='text-align:justify;line-height:200%;font-size:12pt'>
    A kérdésekkel táplálkozásod és anyagcseréd vizsgáljuk. Mindig azt a választ jelöld be, ami a leginkább/legtöbbször igaz rád. Ha úgy érzed, hogy egyik válasz sem illik rád tökéletesen, akkor válaszd azt, amelyik legjobban megközelíti a valóságot. Ne azt nézd, hogy milyennek gondolod magad, hanem próbálj meg ráérezni, hogy milyen vagy valójában. Nincsenek jó vagy rossz válaszok. Ha esetleg néhány válaszban nem vagy biztos, mert sosem figyelted meg ezeket a dolgokat önmagadon (pl. energiát adó ételekkel kapcsolatban), akkor adj magadnak néhány napot, figyeld meg a táplálkozási szokásaidat, és csak utána küldd el a válaszaidat. Légy õszinte, szánj elég idõt a válaszadásra és egyedül töltsd ki a tesztet.
    </td></tr>
...
<td>
    ...
    <table>
    <tr>
    <td style='padding-top:50px;font-size:20pt'><b>TÁPLÁLKOZÁSI NAPLÓ</td></tr>
    <tr>
    <td style='padding-bottom:50px;text-align:justify;line-height:200%;font-size:12pt'>
A Táplálkozási napló kitöltése mindenképpen javasolt legalább 5 napra. Amint azt is elküldted nekünk emailben, elkészítjük a kiértékelésedet és egyeztethetjük az idõpontot a szóbeli kiértékelésre.
    </td></tr>
    </table>
