...
if (count($intol) > 0)
	$elelmiszerList = array_filter($elelmiszerList, function ($elelmiszer) use ($intol) {
		return intolFilter($elelmiszer, $intol);
	});
if (count($izles) > 0)
	$elelmiszerList = array_filter($elelmiszerList, function ($elelmiszer) use ($izles) {
		return izlesFilter($elelmiszer, $izles);
	});
...
function konnyuFilter($elelmiszer)
{
	return $elelmiszer["IsProblemas"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}

function glutenmentesFilter($elelmiszer)
{
	return $elelmiszer["IsGlutentartalmu"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function csucsorfeleFilter($elelmiszer)
{
	return $elelmiszer["IsCsucsorfele"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function olajosmagFilter($elelmiszer)
{
	return $elelmiszer["IsOlajosMag"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function magashisztaminFilter($elelmiszer)
{
	return $elelmiszer["IsMagasHisztamin"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function magasGIFilter($elelmiszer)
{
	return $elelmiszer["IsMagasGI"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function magasFruktozFilter($elelmiszer)
{
	return $elelmiszer["IsMagasFruktoz"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function magasFodmapFilter($elelmiszer)
{
	return $elelmiszer["IsMagasFodmap"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function kozepesFodmapFilter($elelmiszer)
{
	return $elelmiszer["IsKozepesFodmap"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function huvelyesFilter($elelmiszer)
{
	return $elelmiszer["ElelmiszerKategoriaId"] !== "5" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function tojasFilter($elelmiszer)
{
	return $elelmiszer["ElelmiszerKategoriaId"] !== "10" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function refluxFilter($elelmiszer)
{
	return $elelmiszer["IsRefluxTr"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function lektinFilter($elelmiszer)
{
	return $elelmiszer["IsLektin"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function tejKeresztFilter($elelmiszer)
{
	return $elelmiszer["IsTejKereszt"] === "0" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function tejtermekFilter($elelmiszer)
{
	return $elelmiszer["ElelmiszerKategoriaId"] !== "8" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function husFilter($elelmiszer)
{
	return $elelmiszer["ElelmiszerKategoriaId"] !== "9" || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}

function szenhidratFilter($elelmiszer)
{
	return $elelmiszer["MakroForras"] === "1";
}
function feherjeFilter($elelmiszer)
{
	return $elelmiszer["MakroForras"] === "2";
}
function zsirFilter($elelmiszer)
{
	return $elelmiszer["MakroForras"] === "3";
}
function rostFilter($elelmiszer)
{
	return $elelmiszer["MakroForras"] === "4";
}
function egyebFilter($elelmiszer)
{
	return $elelmiszer["MakroForras"] === "0";
}

function intolFilter($elelmiszer, $intol)
{
	return !in_array($elelmiszer["Id"], $intol) || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function izlesFilter($elelmiszer, $izles)
{
	return !in_array($elelmiszer["Id"], $izles) || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
function kiemelesFilter($elelmiszer, $kiemeles)
{
	return !in_array($elelmiszer["Id"], $kiemeles) || in_array($elelmiszer["Id"], (array)$GLOBALS["megisKell"]);
}
?>
<html>
