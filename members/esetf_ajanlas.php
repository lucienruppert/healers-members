...
//showBodyContent("esetf_ajanlas_reszek/1FOOLDAL/FOOLDAL1/FOOLDAL1.html");
print "</div>";
...
// print "<div class='divCommon divTitle'>MEGOLDANDÓK</div>";
// print "<div class='divCommon'>{$rootCausesStr}</div>";

// print "<div class='divCommon divTitle'>A MEGOLDÁS LÉPÉSEI</div>";
// print "<div class='divCommon'>{$solutionStepsStr}</div>";

// print "<div class='divCommon divTitle'>MIBÕL FOGYASSZ TÖBBET</div>";
// print "<div class='divCommon'>{$eatMoreStr}</div>";

print "<div class='divCommon divTitle'>JAVASLATOK</div>";
//print "<div class='divCommon'>${note}</div>";
print "<div class='divCommon'>{$note}</div>";
