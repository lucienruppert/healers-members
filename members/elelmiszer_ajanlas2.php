...
<table id='mainTable' cellpadding="0" cellspacing="0">
	...
	<td class="mainCategory">
		...
		<?php printAjanlasBlokk2($szenhidratList, $kiemeles); ?>
	</td>
	</tr>
	<tr>
	<td class="mainCategory">
		<div class="mainCategoryHeader"><?php echo $pro; ?></div>
		<?php printAjanlasBlokk2($feherjeList, $kiemeles); ?>
	</td>
	</tr>
	<tr>
	<td class="mainCategory">
		<div class="mainCategoryHeader"><?php echo $fat; ?></div>
		<?php printAjanlasBlokk2($zsirList, $kiemeles); ?>
	</td>
	</tr>
	<tr>
	<td class="mainCategory">
		<div class="mainCategoryHeader"><?php echo $fiber; ?></div>
		<?php printAjanlasBlokk2($rostList, $kiemeles); ?>
	</td>
	</tr>
	<tr>
	<?php 
	?>
	<td class="mainCategory">
		<div class="mainCategoryHeader"><?php echo $other; ?></div>
		<?php printAjanlasBlokk2($egyebList, $kiemeles); ?>
	</td>
	</tr>
</table>
